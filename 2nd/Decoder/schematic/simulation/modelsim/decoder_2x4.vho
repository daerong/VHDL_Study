...
-- Y4	=>  Location: PIN_C11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Y1	=>  Location: PIN_B11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \inst1~0_combout\ = (\A0~combout\ & \A1~combout\)
...
-- Equation(s):
-- \inst1~1_combout\ = (!\A0~combout\ & \A1~combout\)
...
-- Equation(s):
-- \inst1~2_combout\ = (\A0~combout\ & !\A1~combout\)
...
-- Equation(s):
-- \inst3~combout\ = (\A0~combout\) # (\A1~combout\)
